      ...
      features: [
        {
          ...
          desc: 'We create engaging modules to help students develop a solid foundation of financial literacy skills.',
        },
        {
          id: 2,
          icon: '/assets/images/equilibrium.png',
          heading: 'Manage Finance Effectively',
          desc: 'Inculcate the habit of using money wisely from an early age & plan your future with the right guidance.',
        },
        {
          id: 3,
          icon: '/assets/images/audio-book.png',
          heading: 'Self-paced Learning',
          desc: 'It is a self-guided course allowing kids to grasp financial concepts. Kids can learn it anytime they want.',
        },
        {
          id: 4,
          icon: '/assets/images/certificate.png',
          heading: 'Get Course Certificate',
          desc: 'Get rewarded upon course completion & empower yourself with essential financial literacy skills.',
        },
        {
          id: 5,
          icon: '/assets/images/work-from-home.png',
          heading: 'Weekly Live Sessions',
          desc: 'We conduct live sessions to keep you up-to-date about the current trends going on in the market.',
        },
      ],
    },
    coursesSection: {
      ...
      features: [
        {
          ...
          desc: 'Guided pathway will assist you in honing your finance knowledge and achieve your financial goals.',
        },
        {
          id: 2,
          icon: '/assets/images/study.png',
          heading: 'Gain Practical Knowledge',
          desc: 'Practical insights into real-world scenarios as well as learn how to effectively manage your finances.',
        },
        {
          id: 3,
          icon: '/assets/images/audio-book.png',
          heading: 'Self-paced Learning',
          desc: 'Flexible courses to cater the dynamic lifestyles of youth, allowing you to learn at your convenience.',
        },
        {
          id: 4,
          icon: '/assets/images/certificate.png',
  ...
  },
  {
    ...
    featuresSection: {
      features: [
        {
          id: 1,
          icon: '/assets/images/online-learning.png',
          heading: 'Online/Offline Training',
          desc: 'A Comprehensive training program for educators to equip you with financial literacy teaching skills.',
        },
        {
          id: 2,
          icon: '/assets/images/books.png',
          heading: 'Guided Teaching Resources',
          desc: 'We offer teacher training and guided teaching resources to provide impactful insights to students.',
        },
        {
          id: 3,
          icon: '/assets/images/teaching.png',
          heading: 'Learn While Teaching',
          desc: 'Enhance your understanding of financial literacy by embracing the concept of "Learn While Teaching".',
        },
        {
          id: 4,
          icon: '/assets/images/certificate.png',
          heading: 'Get Course Certificate',
          desc: 'Acknowledging the commitment of teachers to enhance financial literacy through certification.',
        },
        {
          id: 5,
          icon: '/assets/images/work-from-home.png',
      ...
      features: [
        {
          ...
          desc: 'Aligning with NEP to promote and integrate financial literacy within the education system.',
        },
        {
          id: 2,
          icon: '/assets/images/online-learning.png',
        ...
        },
        {
          ...
          desc: "Schools can use interactive dashboard to track and analyze all student's progress.",
        },
        {
          id: 4,
          icon: '/assets/images/elearning.png',
          heading: 'Track Students Progress',
          desc: 'Personal dashboard allows students and parents to monitor their own course progress.',
        },
        {
          id: 5,
          icon: '/assets/images/work-from-home.png',
