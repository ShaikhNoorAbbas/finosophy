...
export default function LpFooter() {
  return (
    <>
      <div className="mt-10 w-full border-t-8 border-secondary bg-gray-800 p-10 text-center text-white">
        ...
        <div className="py-3">
          <p>
            ...
            existing businesses sell their products and services online. We make
            no claims or representation that by using ClickFunnels you will earn
            money or make your money back. Testimonials shown are real
            experiences from paying users of ClickFunnels. Their business’s
            results are not typical, and your business’s experience will vary
            based upon the effort and education of your business’s employees and
            management, the business model that is implemented, and market
